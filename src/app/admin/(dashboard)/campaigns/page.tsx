...
export default function AdminCampaignsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      <div className="mx-auto max-w-4xl space-y-6 p-4 pb-32 sm:p-6 lg:p-10">
        <header className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          ...
          <div className="mt-5 flex items-start gap-4">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-500 to-blue-600 text-white shadow-lg shadow-cyan-500/25">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">
                İşletmelere toplu WhatsApp/SMS kampanya mesajı gönderin. Kampanya izinlerini yönetin.
              </p>
            </div>
          </div>
