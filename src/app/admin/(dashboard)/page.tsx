    ...
    <div className="space-y-6">
      ...
      <header className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-0.5 text-sm text-slate-500 dark:text-slate-400">Genel durum özeti</p>
        </div>
        <div className="flex flex-wrap gap-2">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-sm font-medium text-slate-700 shadow-sm transition hover:bg-slate-50 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
          >
            Yeni İşletme
          </Link>
          <Link
        ...
        <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900">
          ...
          <ChartBar
            data={[
              ...
              { name: "Toplam Randevu", value: Math.min(normalizedStats.appointmentsTotal, 999) },
