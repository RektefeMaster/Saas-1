...
const COPY = {
  ...
  en: {
    ...
    hero: {
      ...
      titleA: "Not just a bot.",
      titleB: "A full AI platform to run your business.",
      desc:
        "Ahi AI unifies operations, booking, CRM, campaigns, and team productivity in one intelligent flow. Better customer experience, less team friction, more predictable revenue.",
      primary: "Explore Dashboard",
      secondary: "Live Businesses",
      points: [
        "Booking + CRM + Automation in one panel",
        "Multi-tenant architecture and role-based security",
        "Mobile-first, fast, and clean operations",
      ],
    },
    metrics: [
    ...
    solutionsTitle: "What the Platform Unifies",
    solutions: [
      {
        title: "Booking and Capacity Control",
        text: "Handle calendar, availability, cancellation, no-show, and rebooking from one place.",
        icon: CalendarDays,
      },
      {
        title: "CRM Memory and Segmentation",
        text: "Turn notes, tags, reminders, and behavior history into action.",
        icon: BrainCircuit,
      },
      {
        title: "Campaign and Reactivation",
        text: "Send the right message to the right segment and recover churned customers.",
        icon: MessageSquareText,
      },
      {
        title: "Operations Command Center",
        text: "Track delays, cancellations, and critical alerts with clear ownership.",
        icon: CircleGauge,
      },
      {
        title: "AI Assistants",
        text: "Use business-type aware assistant profiles for more accurate outcomes.",
        icon: Bot,
      },
      {
        title: "Security and Scale",
        text: "Grow with 2FA, audit logs, tenant isolation, and secure APIs.",
        icon: ShieldCheck,
      },
    ],
    ...
    flow: [
      ...
      },
      {
        ...
        text: "Booking, reminders, CRM notes, and alerts are synchronized.",
      },
      {
        step: "04",
        title: "Management gets clear visibility",
        text: "KPIs, risks, opportunities, and tasks are shown for decision-making.",
      },
    ],
    cta: {
      title: "Simplify operations while scaling your business.",
      text: "Move from fragmented tools to one intelligent and measurable system with Ahi AI.",
      primary: "Business Login",
      secondary: "Businesses",
    },
    footer: "Ahi AI · AI software platform for businesses",
  },
} as const;
